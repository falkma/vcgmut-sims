...
def run_VCG_script(shift_oligo, plot_dir = 'plots'):
    """
    ...
    oligo_length=25; misaligned_CW_CCW=0; concentration=10.00; global_offset=18;
    ...
    with open(output_filename, 'w') as f:
        ...
        stats = system.run_pcr_protocol(
            ...
            use_stalling=False,           # Use stalling extension function
            nonstalling_fraction=1.0,        # Fraction of unstalled strands
            output_dir=plot_dir
        )
...
for shift_oligo in [5, 10, 20]:  # Fig. 4 A, B, C

    print(f"Running simulation with shift_oligo = {shift_oligo}")
    system, stats = run_VCG_script(shift_oligo, plot_dir='Fig4ABC_plots')
