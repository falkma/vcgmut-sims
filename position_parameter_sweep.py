...
def run_VCG_script(global_offset, plot_dir = 'plots'):
    """
    ...
    oligo_length=25; shift_oligo=5; misaligned_CW_CCW=0; concentration=10.00; 
...
for global_offset in [10, 18, 26]:

    print(f"Running simulation with global_offset = {global_offset}")
    system, stats = run_VCG_script(global_offset, plot_dir='Fig4D_plots')
